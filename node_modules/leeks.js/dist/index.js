...
const supports = isNode ?
    ...
    : false;
exports.supportsColor = supports;
exports.supportsColour = supports;
...
for (const c in Colours_1.default) {
    colours[c] = (t) => enabled ? `\x1b[${Colours_1.default[c]}m${t}\x1b[0m` : t;
}
/**
...
for (const s in Styles_1.default) {
    styles[s] = (t) => `\x1b[${Styles_1.default[s]}m${t}\x1b[0m`;
}
/**
...
for (const k in Keywords_1.default) {
    keywords[k] = (t) => enabled ? rgb(Keywords_1.default[k], t) : t;
}
/**
...
for (const k in Keywords_1.default) {
    bgKeywords[k] = (t) => enabled ? rgbBg(Keywords_1.default[k], t) : t;
}
/**
...
function short(t) {
    return enabled
        ? t
            .replace(/&!?[0-9a-f]/gi, code => `\x1b[${Colours_1.default[ShortCodes_1.default.colours[code]]}m`)
            .replace(/&[i-pr]/gi, code => `\x1b[${Styles_1.default[ShortCodes_1.default.styles[code]]}m`)
