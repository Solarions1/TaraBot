					...
					const response = {
						...
						embeds: [
							new MessageEmbed()
								...
								.setFooter("Ticket by Manu", interaction.guild.iconURL())
						],
						ephemeral: true
					};
			...
			await interaction.reply({
				...
				embeds: [
					new MessageEmbed()
						...
						.setFooter(this.client.utils.footer("Ticket by Manu", i18n('collector_expires_in', 30)), interaction.guild.iconURL())
				],
				ephemeral: true
			});
